...
!*      5) Allocating and initialising the multi-configurational nbf x nbf Hamiltonian matrix
!*      6) Allocating and initialising the single configurational npes x npes Hamiltonian matrices
