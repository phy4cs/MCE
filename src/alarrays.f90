...
!-----------------------------------------------------------------------------------
  ...
  subroutine allocham(H, nbf)
    ...
    if (ierr/=0) then
      write(0,"(a,i0)") "Error in hamiltonian matrix allocation. ierr had value ", ierr
      errorflag=1
      return
    end if
...
!-----------------------------------------------------------------------------------
  ...
  subroutine allochamjk(Hsing)
    ...
    if (ierr/=0) then
      write(0,"(a,i0)") "Error in hamiltonian element allocation. ierr had value ", ierr
      errorflag=1
      return
    end if
...
!-----------------------------------------------------------------------------------
  ...
  subroutine deallocham(H)
    ...
    if (ierr/=0) then
      write(0,"(a,i0)") "Error in hamiltonian matrix deallocation. ierr had value ", ierr
      errorflag=1
      return
    end if
...
!-----------------------------------------------------------------------------------
  ...
  subroutine deallochamjk(Hsing)
    ...
    if (ierr/=0) then
      write(0,"(a,i0)") "Error in hamiltonian element deallocation. ierr had value ", ierr
      errorflag=1
      return
    end if
